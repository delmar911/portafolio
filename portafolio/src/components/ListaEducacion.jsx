  ...
  return (
    <ol class="relative border-s border-gray-200 ">
      <li class="mb-10 ms-6">
        ...
        · Proyectos: Plataforma para personas con limitantes del habla (Texto a voz) <br />
        · Tecnologías: Python, Django, Postman, Javascript, HTML, GitHub, Git, IA.
        </p>
      ...
      <li class="mb-10 ms-6">
        ...
        <time class="block mb-2 text-sm font-normal leading-none text-slate-300">
          Noviembre del 2022
        </time>
        <p class="text-base font-normal text-slate-300">
        · Proyectos: Sistema de inventario para una empresa <br />
